...
{
    public class EnemyDeathView : MonoBehaviour, IDisposable
    {
        ...
        public void Init(EnemyHealthModel healthModel)
        {
            healthModel.IsDead.Subscribe(RunDieFx).AddTo(_disposables);
        }
        ...
        private async UniTask PlayDissolveEffect()
        {
